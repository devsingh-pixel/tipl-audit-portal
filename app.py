...
# 1. Page Configuration (Always at the absolute top)
...
def parse_pdf_locally(file):
    ...
    # Intelligent Defaults (Will be overwritten automatically if strings are found)
    ...
    for line in lines:
        ...
        # 3. Automatic Designation Matcher
    ...
    # Extracted list structure completely isolated from grand totals block
    extracted_items = []
    ...
    for line in expenses_part.split("\n"):
        ...
        if expense_type:
            ...
            if valid_amounts:
                ...
                # EXTREMELY CLEANED & FIXED DICTIONARY BLOCK (No SyntaxError anymore)
...
# ---------- STEP 2: APPLY LOGIC CALCULATION ENGINE ----------
        ...
        for r in records:
            ...
            # --- LODGING ENGINE ---
                ...
                if meta["department"] == "Service-DSIC":
                    ...
                    remarks_slug = "Standard allocation profile limit applied."
                
                # Mumbai Special Top-up Rule (+200 Rs)
                if is_mumbai_stay:
                    base_limit += 200
